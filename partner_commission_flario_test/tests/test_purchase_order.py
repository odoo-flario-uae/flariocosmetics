...
from odoo.addons.partner_commission_flario.tests.setup import Line, Spec, TestCommissionsSetup
...
class TestPurchaseOrder(TestCommissionsSetup):
    ...
    def test_access_rigths(self):
        ...
        commission_user_1 = user('commission_user_1', self.ref('partner_commission_flario.group_commission_user'))
        commission_user_2 = user('commission_user_2', self.ref('partner_commission_flario.group_commission_user'))
        commission_manager = user('commission_manager', self.ref('partner_commission_flario.group_commission_manager'))
